...
<ol dir='rtl'>
    ...
    <img src="جزء مصدر لقطة الشاشة">../media/lab_resources_password.png)">../media/lab_resources_password.png#lightbox)
	<li>
	...
	<li>
	في **OneDrive**، في الزاوية العلوية اليسرى، حدد **+** (إضافة جديد) > **تحميل ملف**.	</li>

    <img src="لقطة الشاشة الخاصة بإضافة ملف جديد">../media/add_new.png)">../media/add_new.png#lightbox)
